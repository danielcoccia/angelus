<form class="form-horizontal mt-4" method="POST" action="cor/atualizar/{{$resultCor[0]->id}}">
@csrf
@method('PUT')
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-4">
                    <select class="form-control select2" id="categoria" name="categoria" required oninvalid="this.setCustomValidity('Campo requerido')">
                        ...
                        @if($resultCategorias->id  == $resultCor[0]->id_categoria_material )
        ...
        <div class="row mt-3">
            ...
            <div class="col-4">
                <input class="form-control" value="{{$resultCor[0]->nome}}" type="text" id="cor" name="cor" required oninvalid="this.setCustomValidity('Campo requerido')">
            </div>
        </div>
        <!-- <div class="row mt-3">
