...
<?php $__env->startSection('content'); ?>
 <!-- start page title -->
                    <div class="row">
                     ...
                     <?php $__env->slot('title'); ?> Email Read  <?php $__env->endSlot(); ?>                     
                     <?php $__env->slot('li1'); ?> Lexa  <?php $__env->endSlot(); ?>
                     <?php $__env->slot('li2'); ?> Email  <?php $__env->endSlot(); ?>
                     <?php $__env->slot('li3'); ?> Email Read <?php $__env->endSlot(); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="email-leftbar card">
                                ...
                                <div class="mt-3">
                                    <a href="#" class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="<?php echo e(URL::asset('/images/users/user-2.jpg')); ?>" alt="Generic placeholder image" height="36">
                                    ...
                                    <a href="#" class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="<?php echo e(URL::asset('/images/users/user-3.jpg')); ?>" alt="Generic placeholder image" height="36">
                                        <div class="media-body chat-user-box">
                                    ...
                                    <a href="#" class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="<?php echo e(URL::asset('/images/users/user-4.jpg')); ?>" alt="Generic placeholder image" height="36">
                                        <div class="media-body chat-user-box">
                                    ...
                                    <a href="#" class="media">
                                        <img class="d-flex mr-3 rounded-circle" src="<?php echo e(URL::asset('/images/users/user-6.jpg')); ?>" alt="Generic placeholder image" height="36">
                                        <div class="media-body chat-user-box">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="media mb-4">
                                            <img class="d-flex mr-3 rounded-circle avatar-sm" src="<?php echo e(URL::asset('/images/users/user-1.jpg')); ?>" alt="Generic placeholder image">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-2 col-6">
                                                <div class="card">
                                                    <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('/images/small/img-3.jpg')); ?>" alt="Card image cap">
                                            ...
                                            <div class="col-xl-2 col-6">
                                                <div class="card">
                                                    <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('/images/small/img-4.jpg')); ?>" alt="Card image cap">
                                                    <div class="my-2 text-center">
                                                        <a href="" class="text-muted font-weight-normal">Download</a>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/LexaLaravel/resources/views/email/email-read.blade.php ENDPATH**/ ?>