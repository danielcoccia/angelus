                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body pt-0">
                            <h3 class="text-center mt-4">
                                <a href="/dashboard/index" class="logo logo-admin"><img src="<?php echo e(URL::asset('/images/logo-dark.png')); ?>" height="30" alt="logo"></a>
                            </h3>
                            <div class="p-3">
...
<?php echo $__env->make('layouts.auth-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/angelus/resources/views/pages/pages-recoverpw.blade.php ENDPATH**/ ?>