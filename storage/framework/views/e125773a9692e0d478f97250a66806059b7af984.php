    ...
    <div class="row"> 
        <div class="col-lg-6">
            <div class="card">
                ...
                <form class="form-horizontal mt-4" method="POST" action="/usuario-atualizar/<?php echo e($resultUsuario[0]->id); ?>"> 
                        ...
                        <table class="table table-bordered table-striped mb-0">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" id="ativo" name="ativo" switch="bool" <?php echo e($resultUsuario[0]->ativo ? 'checked' : ''); ?> />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" id="bloqueado" name="bloqueado" switch="bool" <?php echo e($resultUsuario[0]->bloqueado ? 'checked' : ''); ?>/>
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox" id="<?php echo e($resultPerfils->nome); ?>" name="<?php echo e($resultPerfils->nome); ?>" value="<?php echo e($resultPerfils->id); ?>"  <?php echo e(in_array($resultPerfils->id,$resultPerfisUsuarioArray) ? 'checked' : ''); ?>/>
                                        </td>
                                    </tr>
                                ...
                                <table class="table table-bordered table-striped mb-0">
                                  <?php $__currentLoopData = $resultDeposito; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resultDepositos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" id="<?php echo e($resultDepositos->nome); ?>" name="<?php echo e($resultDepositos->nome); ?>" value="<?php echo e($resultDepositos->id); ?>" <?php echo e(in_array($resultDepositos->id,$resultDepositoUsuarioArray) ? 'checked' : ''); ?>>                                            
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/angelus/resources/views//usuario/alterar-configurar-usuario.blade.php ENDPATH**/ ?>