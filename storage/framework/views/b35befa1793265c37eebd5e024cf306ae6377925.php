                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Cadastro Embalagem</h4>
                                    <hr>
                                    ...
                                    <form class="form-horizontal mt-4" method="POST" action="/cad-embalagem/inserir">
                                    <?php echo csrf_field(); ?>
                                        <div class="form-group row">
                                            <label for="nome" class="col-sm-2 col-form-label">Nova embalagem</label>
                                            <div class="col-sm-10">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" value="" id="sigla" name="sigla">
                                            </div>
                                        </div>                                   
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td><?php echo e($results->sigla); ?></td>
                                                 <td>
                                                    <input class="btn btn-warning" type="reset" value="Alterar">
                                                    <a href="/cad-embalagem/excluir/<?php echo e($results->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/angelus/resources/views//produtos/cad-embalagem.blade.php ENDPATH**/ ?>