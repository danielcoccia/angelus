<header id="page-topbar">
                    ...
                    <div class="float-left">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo e(URL::asset('/images/logo-dark.png')); ?>" alt="" height="19">
                                </span>
                            </a>
                            ...
                            <a href="index" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo e(URL::asset('/images/logo-light.png')); ?>" alt="" height="19">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="float-right">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo e(URL::asset('/images/users/user-4.jpg')); ?>"
                                    alt="Header Avatar">
                            </button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
        ...
        </header><?php /**PATH /var/www/html/LexaLaravel/resources/views/layouts/partials/navbar.blade.php ENDPATH**/ ?>