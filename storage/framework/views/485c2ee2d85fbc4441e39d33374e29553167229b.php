                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/cad-tipo-material/excluir/<?php echo e($results->id); ?>">
...
<?php $__env->startSection('footerScript'); ?>
            ...
            <!-- Datatable init js -->
            <script src="<?php echo e(URL::asset('/js/pages/cad-tipo-material.init.js')); ?>"></script>            
            <script src="<?php echo e(URL::asset('/js/pages/datatables.init.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/angelus/resources/views//produtos/cad-tipo-material.blade.php ENDPATH**/ ?>