                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Cadastro Inicial</h4>
                                    <hr>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Unidade de Medida</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tipo de aquisicao</label>
                                        <div class="col-sm-10">
                                            <select class="form-control">
                                                <option>Selecione</option>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Valor unitario</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" value="" id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tipo de Estoque</label>
                                        <div class="col-sm-10">
                                            <select class="form-control">
                                                <option>Selecione</option>
                                                <option>Tipo 1</option>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tipo de Embalagem</label>
                                        <div class="col-sm-10">
                                            <select class="form-control">
                                                <option>Selecione</option>
                                                <option>Tipo 1</option>
                                    ...
                                    <div class="col-12 mt-3" style="text-align: right;">
                                        ...
                                        <button type="button" class="btn btn-primary">Imprimir Codigo de Barras</button>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/angelus/resources/views/produtos/cad-inicial-prod.blade.php ENDPATH**/ ?>